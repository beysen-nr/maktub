...
class DeliveryScaffold extends StatelessWidget {
  ...
  DeliveryScaffold({super.key, required this.navigationShell});

  int _currentTabIndex(BuildContext context) {
    final location = GoRouterState.of(context).uri.toString();
    if (location.startsWith(RouteNames.deliveryOrder)) return 0;
    if (location.startsWith(RouteNames.profile)) return 1;
    return 0;
  }

  final tabs = [DeliveryDaysScreen(), const ProfileDeliverScreen()];
              ...
              child: BackdropFilter(
                ...
                child: BottomNavigationBar(
                  ...
                  items: List.generate(2, (index) {
                    ...
                    final labels = [AppLocalizations.of(context)!.orders, 'профиль'];
