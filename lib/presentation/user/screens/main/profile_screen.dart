        ...
        children: [
          ...
          _InfoTile(
            ...
            onTap: () {
              showMaktubDialog(
                context: context,
                title: AppLocalizations.of(context)!.forContact,
                content: AppLocalizations.of(context)!.contactTelegramInfo,
                onPressed: () {
                  context.pop();
                },
              );
          ...
          _InfoTile(
            ...
            onTap: () {
              showMaktubDialog(
                context: context,
                title: AppLocalizations.of(context)!.returnProduct,
                content: AppLocalizations.of(context)!.productReturnDescription,
                onPressed: () {
                  context.pop();
                },
              );
            ...
            onTap: () {
final rawPdfUrl = 'https://maktub.kz/privacy-policy.pdf';
final googleViewerUrl = 'https://docs.google.com/gview?embedded=true&url=$rawPdfUrl';
...
launchUrl(
  Uri.parse(googleViewerUrl),
          ...
          _InfoTile(
            ...
            onTap: () {
                      final rawPdfUrl = 'https://maktub.kz/terms-of-use.pdf';
final googleViewerUrl = 'https://docs.google.com/gview?embedded=true&url=$rawPdfUrl';
              ...
              onTap: () {
                showMaktubDialog(
                  ...
                  content: AppLocalizations.of(
                    context,
                  )!.accountDeleteInstruction,
                  onPressed: () {
                    String phone = appState.phone;
                    if(phone!='77779477797'){
                    context.read<AuthBloc>().add(AuthDeleteRequested(phone));
                    }
